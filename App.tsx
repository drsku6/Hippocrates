...
import { EvidenceFlowAIIcon, UserIcon, SendIcon, LoadingIcon, CopyIcon, CheckIcon } from './components/icons';
  ...
  const sendMessage = useCallback(async (messageContent: string) => {
    ...
    if (isCommand) {
        ...
        if (commandName) {
            ...
            loadingMessage = `EvidenceFlowAI is processing your command...`;
        }
    }
    ...
    setMessages(prev => [...prev, EvidenceFlowAIResponsePlaceholder]);
          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center text-brand-text-secondary p-8">
              ...
              <p className="max-w-md">
                Describe your patient's case to start the conversation with EvidenceFlowAI. You can provide the HPI, vitals, labs, and your initial thoughts.
              </p>
            </div>
          )}
